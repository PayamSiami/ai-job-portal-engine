...
class PDFService {
    ...
    getPDFPath(resumeId) {
        try {
            ...
            const pdfFile = files.find((file) => file.includes(resumeId) && file.endsWith(".pdf"));
            if (pdfFile) {
    ...
    renderSidebarSection(doc, title, x, y) {
        doc
            .fillColor("#F3E8FF")
            .fontSize(9)
            .font("Helvetica-Bold")
    ...
    generateModernTemplate(doc, resume) {
        ...
        if (personalInfo.linkedin)
            contactItems.push(`🔗 ${personalInfo.linkedin}`);
        if (personalInfo.github)
            contactItems.push(`💻 ${personalInfo.github}`);
            ...
            Object.entries(groupedSkills).forEach(([category, skillList]) => {
                ...
                skillList.forEach((skill) => {
                    ...
                    doc
                        ...
                        .fontSize(8)
                        .font("Helvetica")
                        .text(`• ${skill.name} ${stars}`, leftCol + (category !== "General" ? 10 : 0), leftY);
                    leftY += 13;
                });
                leftY += 5;
            });
            ...
            projects.forEach((project) => {
                ...
                if (project.technologies && project.technologies.length > 0) {
                    doc
                        ...
                        .fontSize(7)
                        .font("Helvetica-Bold")
                        .text(`Tech: ${project.technologies.join(" • ")}`, rightCol + 10, rightY, {
                        width: colWidth - 10,
                    });
                    rightY += 16;
                }
    ...
    generateCreativeTemplate(doc, resume) {
        ...
        doc
            ...
            .fontSize(16)
            .font("Helvetica-Bold")
            .text(`${personalInfo.firstName} ${personalInfo.lastName}`, 60, sidebarY, {
            ...
            projects.forEach((project) => {
                ...
                if (project.technologies && project.technologies.length > 0) {
                    doc
                        ...
                        .fontSize(7)
                        .font("Helvetica-Bold")
                        .text(`Tech: ${project.technologies.join(" • ")}`, contentX + 17, y, {
                        width: contentWidth - 17,
                    });
                    y += 16;
                }
